...
ROOT_URLCONF = 'jzargo.urls'

WSGI_APPLICATION = 'jzargo.wsgi.application'
...
INTERNAL_IPS =  ("95.150.121.173",
)
# Static files (CSS, JavaScript, Images)
# https://docs.djangoproject.com/en/1.6/howto/static-files/

ADMIN = (
	('Fayaaz Ahmed', 'fayaaz.ahmed@gmail.com'),
)
